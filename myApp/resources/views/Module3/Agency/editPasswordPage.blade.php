...
<body>
	...
	<main class="content-area">
		<section class="content-container">
			...
			<div class="meta">
				Logged in as <strong>{{ $agency->AgencyName }}</strong> ({{ $agency->AgencyEmail }})
			</div>
			...
			@if (!session('agency_password_verified'))
				<form method="POST" action="{{ route('agency.password.verify') }}">
					...
					<div class="actions">
						...
						<a href="{{ route('agency.profile') }}" class="btn btn-ghost"><i class="fa-solid fa-user"></i> Back to Profile</a>
					</div>
				</form>
			@else
				<form method="POST" action="{{ route('agency.password.update') }}">
					...
					<div class="actions">
						...
						<a href="{{ route('agency.password.edit.reset') }}" class="btn btn-ghost"><i class="fa-solid fa-rotate-left"></i> Reset Verification</a>
					</div>
				</form>
			@endif
		</section>

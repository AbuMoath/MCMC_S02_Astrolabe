		...
		<section class="content-container">
			...
			<div class="profile-summary">
				<div class="profile-pic-container">
					<img src="{{ $agency->profile_picture_url ?? asset('images/default-agency-avatar.png') }}" alt="Agency avatar">
				</div>
				<div>
					<div class="profile-name">{{ $agency->AgencyName }}</div>
					<div class="profile-meta">{{ $agency->AgencyEmail }} · {{ $agency->AgencyUserName }}</div>
				</div>
			</div>
			...
			<form method="POST" action="{{ route('agency.profile.update') }}" enctype="multipart/form-data">
				...
				<div class="grid">
					<div class="field">
						...
						<input id="AgencyName" type="text" name="AgencyName" value="{{ old('AgencyName', $agency->AgencyName) }}" required>
					</div>

					<div class="field">
						<label for="AgencyEmail">Agency Email</label>
						<input id="AgencyEmail" type="email" name="AgencyEmail" value="{{ old('AgencyEmail', $agency->AgencyEmail) }}" required>
					</div>

					<div class="field">
						<label for="AgencyPhoneNum">Agency Phone Number</label>
						<input id="AgencyPhoneNum" type="text" name="AgencyPhoneNum" value="{{ old('AgencyPhoneNum', $agency->AgencyPhoneNum) }}" placeholder="Optional">
					</div>
				...
				<div class="actions">
					...
					<a href="{{ route('agency.security') }}" class="btn btn-ghost"><i class="fa-solid fa-shield-halved"></i> Go to Security</a>
				</div>
			</form>
		</section>
	</main>

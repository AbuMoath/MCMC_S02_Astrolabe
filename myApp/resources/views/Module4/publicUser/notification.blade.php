...
<body>
    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            <a href="{{ url()->previous() !== request()->url() && url()->previous() !== '' ? url()->previous() : route('home') }}" class="sidebar-link">
    ...
    <div class="main-content">        <div class="content-card">
            ...
            <div class="nav-buttons">
                <a href="{{ route('inquiries.index') }}" class="nav-btn">
                    <i class="fas fa-list"></i>
                    View Inquiry List
                </a>
                <a href="{{ route('submit.inquiry') }}" class="nav-btn">

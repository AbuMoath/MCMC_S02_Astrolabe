        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('admin.otp.verify') }}" id="otpForm" novalidate>
                ...
                <div class="otp-input-wrapper">
                    <input type="text" maxlength="1" class="otp-digit @error('otp_code') is-invalid @enderror"
            ...
            <div style="text-align:center; margin-top:1.2rem;">
                <a href="{{ route('login') }}" style="color:#506a9f; font-weight:500; text-decoration:none; font-size:0.9rem;">

...
<body>
    ...
    <div class="page-wrapper">
        <div class="auth-card">
            ...
            {{-- Show the masked email address where OTP was sent --}}
            ...
            {{-- ======================================================
                 ...
                 Backend: POST {{ route('admin.otp.verify') }}
                 Controller: Module3\Admin\AdminController@verifyOTP
                 Field: otp_code (hidden, built from 6 digit inputs)
            ====================================================== --}}
            <form method="POST" action="{{ route('admin.otp.verify') }}" id="otpForm" novalidate>
                @csrf

                {{-- Hidden field that holds the concatenated 6-digit OTP --}}
            ...
            {{-- ======================================================
                 RESEND OTP FORM
                 Backend: POST {{ route('admin.otp.resend') }}
                 Controller: Module3\Admin\AdminController@resendOTP
            ====================================================== --}}

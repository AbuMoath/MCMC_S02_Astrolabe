...
<body>
    ...
    <nav class="navbar" id="navbar">
        ...
        <div class="nav-actions">
            <a href="{{ route('login') }}" class="btn-ghost" id="nav-login-btn">
                <i class="fas fa-arrow-right-to-bracket"></i> Login
            </a>
            <a href="{{ route('register') }}" class="btn-primary-nav" id="nav-register-btn">
    ...
    <div class="mobile-menu" id="mobile-menu">
        ...
        <hr class="divider">
        <a href="{{ route('login') }}"><i class="fas fa-arrow-right-to-bracket"></i> Login</a>
        <a href="{{ route('register') }}" style="color: var(--blue-light); font-weight:700;"><i class="fas fa-user-plus"></i> Register Now</a>
    </div>
    ...
    <section class="hero">
        <div style="max-width: 860px; margin: 0 auto;">
            ...
            <div class="hero-actions">
                <a href="{{ route('register') }}" class="btn-hero-primary" id="hero-submit-btn">
                    <i class="fas fa-paper-plane"></i>
                    Submit an Inquiry
                </a>
                <a href="{{ route('login') }}" class="btn-hero-secondary" id="hero-track-btn">
    ...
    <section class="cta-section">
        <div class="cta-card reveal">
            ...
            <div class="cta-buttons">
                <a href="{{ route('register') }}" class="btn-hero-primary" id="cta-register-btn">
                    <i class="fas fa-user-plus"></i> Create Free Account
                </a>
                <a href="{{ route('login') }}" class="btn-hero-secondary" id="cta-login-btn">
        ...
        <div class="footer-inner">
            <div class="footer-top">
                <div class="footer-brand">
                    <a href="{{ route('home') }}" class="nav-brand" style="margin-bottom:0.75rem; display:inline-flex;">
                        <div class="nav-logo-icon">
                            <i class="fas fa-shield-halved"></i>
                        </div>
                        <div class="nav-brand-text">
            ...
            <div class="footer-bottom">
                <p>&copy; {{ date('Y') }} AuthenticityHub &mdash; Malaysian Communications and Multimedia Commission. All rights reserved. <a href="#">Privacy Policy</a></p>
    ...
    @if (session('success'))
        ...
        ">
            ...
            <span style="font-size:0.9rem; font-weight:500; color:#d1fae5;">{{ session('success') }}</span>
        </div>
    @endif

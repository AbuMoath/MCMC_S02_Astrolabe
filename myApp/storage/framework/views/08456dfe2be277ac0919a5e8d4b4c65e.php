...
<body>
    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            <a href="<?php echo e(route('agency.home')); ?>" class="sidebar-link">
                <i class="fas fa-arrow-left"></i> <span>Back</span>
            </a>
            <a href="<?php echo e(route('agency.profile')); ?>" class="sidebar-link">
                <i class="fas fa-user"></i> <span>Profile</span>
            </a>
            <a href="#" class="sidebar-link">
                <i class="fas fa-cog"></i> <span>Settings</span>
            </a>
            <a href="<?php echo e(route('agency.security')); ?>" class="sidebar-link">
    ...
    <div class="main-content">        <div class="content-card">
            ...
            <div class="nav-buttons">
                <a href="<?php echo e(route('agency.view.display.inquiry')); ?>" class="nav-btn">
...
<?php /**PATH C:\xampp\htdocs\SPM\MCMC_S02_Astrolabe\myApp\resources\views/Module4/agency/notification.blade.php ENDPATH**/ ?>
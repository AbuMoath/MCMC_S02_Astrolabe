...
<body> <!-- Top Bar -->
    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            <a href="<?php echo e(route('admin.home')); ?>" class="sidebar-link active">
    ...
    <div class="content-area">
        ...
        <div class="dashboard-header">
            ...
            <p class="dashboard-subtitle">Welcome back, <?php echo e($admin->AdminName ?? 'Administrator'); ?>! Here's what's
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-number"><?php echo e($stats['total_inquiries']); ?></div>
                <div class="stat-label">Total Inquiries</div>
            </div>
            <div class="stat-card">
                <i class="stat-icon fas fa-clock"></i>
                <div class="stat-number"><?php echo e($stats['pending_inquiries']); ?></div>
                <div class="stat-label">Pending Review</div>
            </div>
            <div class="stat-card">
                <i class="stat-icon fas fa-building"></i>
                <div class="stat-number"><?php echo e($stats['total_agencies']); ?></div>
        ...
        <div class="quick-actions">
            <div class="action-card" onclick="location.href='<?php echo e(route('admin.assign.inquiry')); ?>'">
            ...
            <div class="action-card" onclick="location.href='<?php echo e(route('admin.inquiries')); ?>'">
                <div class="action-icon">
                    <i class="fas fa-search"></i>
                </div>
            ...
            <div class="action-card" onclick="location.href='<?php echo e(route('admin.agency.register')); ?>'">
                <div class="action-icon">
            ...
            <div class="action-card" onclick="location.href='<?php echo e(route('admin.users')); ?>'">
                <div class="action-icon">
                    <i class="fas fa-cog"></i>
                </div>
            ...
            <div class="action-card" onclick="location.href='<?php echo e(route('admin.reports')); ?>'">
                <div class="action-icon">
                ...
                <?php $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="activity-item">
                        <div class="activity-icon">
                            <i class="fas
                                <?php if($activity->InquiryStatus === 'Pending'): ?> fa-clock
                                <?php elseif($activity->InquiryStatus === 'Under Investigation'): ?> fa-search
                                <?php elseif($activity->InquiryStatus === 'Verified as True'): ?> fa-check-circle
                                <?php elseif($activity->InquiryStatus === 'Identified as Fake'): ?> fa-times-circle
                                <?php elseif($activity->InquiryStatus === 'Rejected'): ?> fa-ban
                        ...
                        <div class="activity-content">
                            <div class="activity-title">
                                <?php if($activity->AgencyID && $activity->InquiryStatus !== 'Pending'): ?>
                                    Inquiry "<?php echo e(Str::limit($activity->InquiryTitle, 30)); ?>" — Status: <?php echo e($activity->InquiryStatus); ?>

                                    <?php if($activity->agency): ?>
                                        (<?php echo e($activity->agency->AgencyName); ?>)
                                    <?php endif; ?>
                                <?php elseif($activity->AgencyID): ?>
                                    Inquiry "<?php echo e(Str::limit($activity->InquiryTitle, 30)); ?>" assigned to <?php echo e($activity->agency->AgencyName ?? 'agency'); ?>

                                <?php else: ?>
                                    New inquiry submitted: "<?php echo e(Str::limit($activity->InquiryTitle, 30)); ?>"
                                <?php endif; ?>
                            </div>
                            <div class="activity-time"><?php echo e($activity->updated_at ? $activity->updated_at->diffForHumans() : $activity->created_at->diffForHumans()); ?></div>
                        </div>
                    </div>
            ...
            document.addEventListener('keydown', function(e) {
                if (e.ctrlKey || e.metaKey) {
                    switch (e.key) {
                        case '1':
                            e.preventDefault();
                            location.href = '<?php echo e(route('admin.assign.inquiry')); ?>';
                            break;
                        case '2':
                            e.preventDefault();
                            location.href = '<?php echo e(route('admin.inquiries')); ?>';
                            break;
                        case '3':
                            e.preventDefault();
                        ...
                        case '4':
                            e.preventDefault();
                            location.href = '<?php echo e(route('admin.reports')); ?>';
                            break;
                    }
                }
            });
...
<?php /**PATH C:\xampp\htdocs\SPM\MCMC_S02_Astrolabe\myApp\resources\views/Module3/Admin/adminHome.blade.php ENDPATH**/ ?>
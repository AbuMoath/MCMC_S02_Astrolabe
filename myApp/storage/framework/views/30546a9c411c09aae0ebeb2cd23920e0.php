...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.reports')); ?>" class="sidebar-link active">
    ...
    <div class="main-content">
        <div class="card">
            <div class="report-tabs">
                ...
                <a href="#" class="report-tab" id="agency-performance-tab">
            ...
            <div id="users-report-form">
                ...
                <form action="<?php echo e(route('admin.reports.generate')); ?>" method="POST" id="usersReportForm">
                    <?php echo csrf_field(); ?>
            ...
            <div id="inquiry-report-form" style="display: none;">
                ...
                <form action="<?php echo e(route('admin.reports.generate')); ?>" method="POST" id="inquiriesReportForm">
                    <?php echo csrf_field(); ?>
            ...
            <div id="assignment-report-form" style="display: none;">
                ...
                <form action="<?php echo e(route('admin.reports.generate')); ?>" method="POST" id="assignmentReportForm">
                    <?php echo csrf_field(); ?>
        ...
        <!-- Agency Performance Reports Form -->
        <div id="agency-performance-report-form" style="display: none;">
            <div class="card">
                <h2 class="form-header">Agency Performance Analytics</h2>
                <p class="form-description">Generate comprehensive performance reports for agencies including metrics like assigned/resolved/pending inquiries, average resolution time, and performance analytics.</p>

                <form action="<?php echo e(route('admin.reports.generate')); ?>" method="POST" id="agencyPerformanceReportForm">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="report_category" value="agency_performance">
                    <input type="hidden" name="format" id="agency-performance-format" value="">

                    <div class="form-group">
                        <label for="agency_performance_report_type">Report Type</label>
                        <select id="agency_performance_report_type" name="report_type" required>
                            <option value="">Select Report Type</option>
                    ...
                    <div class="form-group">
                        <label for="performance_date_from">Performance Period From (Optional)</label>
                        <input type="date" id="performance_date_from" name="date_from" class="form-control">
                        <small class="form-help">Leave blank to include all performance data regardless of date</small>
                    </div>

                    <div class="form-group">
                        <label for="performance_date_to">Performance Period To (Optional)</label>
                        <input type="date" id="performance_date_to" name="date_to" class="form-control">
                        <small class="form-help">Leave blank to include all performance data regardless of date</small>
                    </div>

                    <div class="form-group">
                        <label for="performance_agency">Agency</label>
                        <select id="performance_agency" name="agency_id">
                            <option value="">All Agencies</option>
                            <?php
                                $agencies = $agencies ?? [];
                            ?>
                    ...
                    <div class="form-group">
                        <label for="performance_category">Inquiry Category</label>
                        <select id="performance_category" name="category">
                    ...
                    <div class="form-group">
                        <label for="include_performance_charts">Include Visual Analytics</label>
                        <select id="include_performance_charts" name="include_charts">
                            <option value="yes">Yes - Include Charts and Graphs</option>
                            <option value="no">No - Data Only</option>
                        </select>
                        <small class="form-help">Charts include: Performance trends, resolution time analytics, workload distribution, comparative performance metrics</small>
                    </div>

                    <div class="format-buttons">
                        <button type="button" data-format="pdf" class="format-btn pdf-btn"
                            onclick="submitAgencyPerformanceReport('pdf')">
                            <i class="fas fa-file-pdf"></i> Download PDF
                        </button>
                        <button type="button" data-format="excel" class="format-btn excel-btn"
                            onclick="submitAgencyPerformanceReport('excel')">
                            <i class="fas fa-file-excel"></i> Download Excel
                        </button>
                    </div>
                </form>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.submitAgencyPerformanceReport = function(format) {
                const form = document.getElementById('agencyPerformanceReportForm');
                const formatInput = document.getElementById('agency-performance-format');
                const button = document.querySelector(`#agency-performance-report-form [data-format="${format}"]`);
                ...
                console.log('Submitting agency performance report with format:', format);
            ...
            const agencyPerformanceTab = document.getElementById('agency-performance-tab');
            ...
            const agencyPerformanceForm = document.getElementById('agency-performance-report-form');

            function switchTab(activeTab, activeForm) {
                // Update tab states
                [usersTab, inquiriesTab, assignmentsTab, agencyPerformanceTab].forEach(tab => {
                    tab.classList.remove('active');
                });
                activeTab.classList.add('active');

                // Hide all forms
                [usersForm, inquiryForm, assignmentForm, agencyPerformanceForm].forEach(form => {
                    if (form !== activeForm) {
            ...
            agencyPerformanceTab.addEventListener('click', function(e) {
                e.preventDefault();
                if (!agencyPerformanceTab.classList.contains('active')) {
                    switchTab(agencyPerformanceTab, agencyPerformanceForm);
                }
            });
...
<?php /**PATH C:\xampp\htdocs\mcmc\myApp\resources\views/shared admin page/generateReportPage.blade.php ENDPATH**/ ?>
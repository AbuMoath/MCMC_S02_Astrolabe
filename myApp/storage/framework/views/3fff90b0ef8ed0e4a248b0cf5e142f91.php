...
<body> <!-- Top Bar -->
    <header class="top-bar">
        ...
        <div class="user-area">
            <div class="welcome">
                <div><?php echo e($agency->AgencyName ?? 'Agency'); ?></div>
                <div style="font-size: 0.75rem; opacity: 0.8;">Welcome</div>
            </div>
            <div class="profile-pic-container">
                <?php if(isset($agency->AgencyProfilePicture) && $agency->AgencyProfilePicture): ?>
                    <img src="<?php echo e(asset('storage/' . $agency->AgencyProfilePicture)); ?>" alt="Profile Picture">
                <?php else: ?>
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($agency->AgencyName ?? 'Agency')); ?>&background=eeeeee&color=666666"
                        alt="Profile Picture">
                <?php endif; ?>
            </div>
        </div>
    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            <a href="<?php echo e(route('agency.home')); ?>" class="sidebar-link"><i class="fas fa-home"></i> <span>Home</span></a>
            <a href="<?php echo e(route('agency.profile')); ?>" class="sidebar-link"><i class="fas fa-cog"></i>
                <span>Profile</span></a>
            <a href="<?php echo e(route('agency.security')); ?>" class="sidebar-link"><i class="fas fa-shield-alt"></i>
                <span>Security</span></a>
            <a href="#" class="sidebar-link active"><i class="far fa-clipboard"></i> <span>Display and
                    Approved</span></a>
            <a href="<?php echo e(route('login')); ?>" class="sidebar-link logout-link"><i class="fas fa-sign-out-alt"></i>
                <span>Logout</span></a>
        </nav>
    </aside>
        ...
        <div class="content-container">
            ...
            <div class="main-content">
                ...
                <div
                        ...
                        <div style="display: flex; align-items: center; gap: 1rem;">
                            ...
                            <div>
                                <div style="font-size: 1.5rem; font-weight: 700; color: #1f2937;">
                                    <?php echo e($statusCounts['total'] ?? 0); ?></div>
                    ...
                    <div
                        ...
                        <div style="display: flex; align-items: center; gap: 1rem;">
                            ...
                            <div>
                                <div style="font-size: 1.5rem; font-weight: 700; color: #1f2937;">
                                    <?php echo e($statusCounts['under_investigation'] ?? 0); ?></div>
                    ...
                    <div
                        ...
                        <div style="display: flex; align-items: center; gap: 1rem;">
                            ...
                            <div>
                                <div style="font-size: 1.5rem; font-weight: 700; color: #1f2937;">
                                    <?php echo e($statusCounts['verified_true'] ?? 0); ?></div>
                    ...
                    <div
                        ...
                        <div style="display: flex; align-items: center; gap: 1rem;">
                            ...
                            <div>
                                <div style="font-size: 1.5rem; font-weight: 700; color: #1f2937;">
                                    <?php echo e($statusCounts['identified_fake'] ?? 0); ?></div>
                ...
                <div id="inquiriesList">
                    <?php if(isset($inquiries) && $inquiries->count() > 0): ?>
                        <?php $__currentLoopData = $inquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="inquiry-card" data-status="<?php echo e($inquiry->InquiryStatus); ?>"
                                data-priority="<?php echo e($inquiry->InquiryPriority ?? 'Normal'); ?>">
                                    ...
                                    <div
                                        ...
                                        <div style="flex: 1;">
                                            <h3
                                                ...
                                                <?php echo e($inquiry->InquiryTitle); ?>

                                            </h3>
                                            <div style="display: flex; gap: 1rem; align-items: center;">
                                                <span style="font-size: 0.875rem; color: #6b7280;">
                                                    <i class="fas fa-hashtag"></i> <?php echo e($inquiry->InquiryID); ?>
                                                ...
                                                <span
                                                    class="status-badge priority-<?php echo e(strtolower($inquiry->InquiryPriority ?? 'normal')); ?>">
                                                    <?php echo e($inquiry->InquiryPriority ?? 'Normal'); ?> Priority
                                                </span>
                                            </div>
                                        </div>
                                        <div style="text-align: right;">
                                            <div style="font-size: 0.875rem; color: #6b7280;">
                                                Assigned:
                                                <?php echo e($inquiry->assignment_date ? $inquiry->assignment_date->format('M d, Y') : 'N/A'); ?>

                                            </div>
                                            <?php if($inquiry->user): ?>
                                                <div style="font-size: 0.75rem; color: #6b7280;">
                                                    Submitted by: <?php echo e($inquiry->user->UserName); ?>
                                ...
                                <div class="inquiry-body">
                                    <div style="margin-bottom: 1rem;">
                                        ...
                                        <span
                                            style="color: #6b7280;"><?php echo e($inquiry->InquirySource ?? 'Not specified'); ?></span>
                                    </div>
                                    <div style="margin-bottom: 1rem;">
                                        <strong style="color: #374151;">Description:</strong>
                                        <p style="color: #6b7280; margin-top: 0.5rem; line-height: 1.5;">
                                            <?php echo e(Str::limit($inquiry->InquiryDescription, 200)); ?>

                                        </p>
                                    </div>
                                    <?php if($inquiry->InquiryEvidence): ?>
                                        <div>
                                ...
                                <div class="inquiry-actions">
                                    <button onclick="showInquiryDetails(<?php echo e($inquiry->InquiryID); ?>)"
                                        class="btn btn-primary">
                                        <i class="fas fa-eye"></i>
                                        Show Full Details
                                    </button>

                                    <button onclick="showAddNotesModal(<?php echo e($inquiry->InquiryID); ?>)"
                                        class="btn btn-secondary">
                                        <i class="fas fa-sticky-note"></i>
                                        Add Notes
                                    </button>

                                    <button onclick="showStatusModal(<?php echo e($inquiry->InquiryID); ?>)"
                                        class="btn btn-success">
                                        <i class="fas fa-edit"></i>
                                        Update Status
                                    </button>

                                    <?php if($inquiry->InquiryStatus === 'Pending' || $inquiry->InquiryStatus === 'Under Investigation'): ?>
                                        ...
                                        <?php else: ?>
                                            <button onclick="showRequestReassignmentModal(<?php echo e($inquiry->InquiryID); ?>)"
                                        ...
                                        <button onclick="rejectInquiry(<?php echo e($inquiry->InquiryID); ?>)"
                    ...
                    <div class="modal-body">
                        ...
                        <form id="addNotesForm" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="notesAgencyName" class="form-input" readonly style="background: #f9fafb;" value="<?php echo e($agency->AgencyName ?? 'Agency'); ?>">
                            </div>
            ...
            <script>
                let allInquiries = <?php echo json_encode($inquiries ?? [], 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\mcmc\myApp\resources\views/Module 3/Agency/ViewAndDisplayInquiry.blade.php ENDPATH**/ ?>
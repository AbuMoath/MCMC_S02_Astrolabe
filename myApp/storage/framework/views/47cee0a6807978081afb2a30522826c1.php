...
<body>
    ...
    <header class="top-bar">
        ...
        <div class="user-area">
            <div class="welcome">
                <div><?php echo e($agency->AgencyName); ?></div>
            ...
            <label for="AgencyProfilePicture" class="profile-pic-container">
                <?php if($agency->AgencyProfilePicture): ?>
                    <img id="profilePicPreview" src="<?php echo e(asset('storage/' . $agency->AgencyProfilePicture)); ?>"
                        alt="Profile Picture">
                <?php else: ?>
                    <img id="profilePicPreview"
                        src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($agency->AgencyName)); ?>&background=eeeeee&color=666666"
                        alt="Profile Picture">
                <?php endif; ?>
            </label>
        </div>
                    ...
                    <label for="AgencyProfilePicture" class="profile-card-picture">
                        <?php if($agency->AgencyProfilePicture): ?>
                            <img id="cardProfilePicPreview"
                                src="<?php echo e(asset('storage/' . $agency->AgencyProfilePicture)); ?>" alt="Profile Picture">
                        <?php else: ?>
                            <img id="cardProfilePicPreview"
                                src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($agency->AgencyName)); ?>&background=eeeeee&color=666666"
                                alt="Profile Picture">
                    ...
                    <div>
                        <div class="form-group" style="--delay: 1">
                            ...
                            <input type="text" name="AgencyName" id="AgencyName"
                                value="<?php echo e(old('AgencyName', $agency->AgencyName)); ?>" required />
                            <?php $__errorArgs = ['AgencyName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                <div style="color: #e53e3e; font-size: 0.875rem; margin-top: 0.5rem;"><?php echo e($message); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group" style="--delay: 3">
                            ...
                            <input type="text" name="AgencyUserName" id="AgencyUserName"
                                value="<?php echo e(old('AgencyUserName', $agency->AgencyUserName)); ?>" required />
                            <?php $__errorArgs = ['AgencyUserName'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div>
                        <div class="form-group" style="--delay: 2">
                            ...
                            <input type="email" name="AgencyEmail" id="AgencyEmail"
                                value="<?php echo e(old('AgencyEmail', $agency->AgencyEmail)); ?>" />
                            <?php $__errorArgs = ['AgencyEmail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group" style="--delay: 4">
                            ...
                            <input type="text" name="AgencyPhoneNum" id="AgencyPhoneNum"
                                value="<?php echo e(old('AgencyPhoneNum', $agency->AgencyPhoneNum)); ?>" />
                            <?php $__errorArgs = ['AgencyPhoneNum'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\xampp\htdocs\mcmc\myApp\resources\views/Module1/agency/manageProfilePage.blade.php ENDPATH**/ ?>
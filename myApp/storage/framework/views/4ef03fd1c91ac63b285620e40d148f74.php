            ...
            <?php if(isset($notifications) && $notifications->count() > 0): ?>
                <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="notification-item <?php echo e(!$notification->is_read ? 'unread' : ''); ?>">
                        <?php if($notification->type == 'status_update' || $notification->type == 'inquiry_update'): ?>
                            ...
                            <div class="notification-date">
                                Updated: <?php echo e($notification->created_at->format('M j, Y \a\t g:i A')); ?>
                        ...
                        <?php elseif($notification->type == 'agency_note'): ?>
                            ...
                            <div class="notification-date">
                                Sent: <?php echo e($notification->created_at->format('M j, Y \a\t g:i A')); ?>
...
<?php /**PATH C:\xampp\htdocs\SPM\MCMC_S02_Astrolabe\myApp\resources\views/Module4/publicUser/notification.blade.php ENDPATH**/ ?>
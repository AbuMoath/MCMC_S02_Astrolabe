    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('manage.profile')); ?>" class="sidebar-link active">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data">
                ...
                <div class="profile-header">
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-gray-800"><?php echo e(Auth::user()->UserName); ?></h3>
                        <p class="text-gray-500"><?php echo e(Auth::user()->UserEmail); ?></p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="UserEmail" name="UserEmail" class="form-input"
                               value="<?php echo e(old('UserEmail', Auth::user()->UserEmail)); ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="UserPhoneNum" name="UserPhoneNum" class="form-input"
                               value="<?php echo e(old('UserPhoneNum', Auth::user()->UserPhoneNum)); ?>" placeholder="e.g. 012-3456789">
                    </div>

                    <div class="form-group">
                        <label for="UserID" class="form-label">User ID</label>
                        <input type="text" id="UserID" class="form-input" value="<?php echo e(Auth::user()->UserID); ?>" readonly>
                    </div>
                </div>
            ...
            <a href="<?php echo e(route('password.verify')); ?>" class="text-blue-600 hover:text-blue-800 font-semibold inline-flex items-center gap-2"
               onclick="event.preventDefault(); document.getElementById('verify-form').submit();">
                <i class="fas fa-key"></i> Change Password
            </a>
            
            <form id="verify-form" method="POST" action="<?php echo e(route('password.verify')); ?>" class="hidden">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\SPM\MCMC_S02_Astrolabe\myApp\resources\views/Module3/PublicUser/manageProfilePage.blade.php ENDPATH**/ ?>
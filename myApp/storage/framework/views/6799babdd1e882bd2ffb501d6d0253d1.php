            ...
            <div class="card">
                ...
                <form method="POST" action="<?php echo e(route('register')); ?>" novalidate>
                    ...
                    <input type="text" name="UserName" value="<?php echo e(old('UserName')); ?>"
                        class="input-smooth <?php $__errorArgs = ['UserName'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <input type="email" name="UserEmail" value="<?php echo e(old('UserEmail')); ?>"
                        class="input-smooth <?php $__errorArgs = ['UserEmail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <input type="password" name="UserPassword"
                        class="input-smooth <?php $__errorArgs = ['UserPassword'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php /**PATH C:\xampp\htdocs\mcmc\myApp\resources\views/Module1/publicUser/registerPage.blade.php ENDPATH**/ ?>
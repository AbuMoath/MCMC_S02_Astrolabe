...
<body>
    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.assign.inquiry')); ?>" class="sidebar-link active">
                <i class="fas fa-tasks"></i>
                <span>Assign Inquiry</span>
            </a>
            <a href="<?php echo e(route('admin.inquiries')); ?>" class="sidebar-link">
    ...
    <div class="main-content">
        ...
        <div id="assignPage" class="content-page">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($inquiries->count()); ?></div>
                    <div class="stat-label">Total Inquiries</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($inquiries->whereNull('AgencyID')->count()); ?></div>
                    <div class="stat-label">Unassigned</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($inquiries->where('InquiryStatus', 'Pending')->count()); ?></div>
                    <div class="stat-label">Pending Review</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($agencies->count()); ?></div>
            ...
            <div class="card">
                ...
                <?php endif; ?>                <!-- Assignment Section -->
                <div class="assignment-section">
                    <h3 class="text-lg font-semibold text-[#333] mb-4">
                        <i class="fas fa-hand-point-right mr-2"></i>Bulk Assignment with Comments
                    </h3>
                    <form method="POST" action="<?php echo e(route('admin.assign.inquiries')); ?>" class="assignment-form" id="assignmentForm">
                        <?php echo csrf_field(); ?>
                        <div class="flex flex-col gap-4 w-full">
                            ...
                            <div class="flex gap-4 items-start w-full">
                                <select name="agency_id" required class="form-select flex-1">
                                    ...
                                    <?php $__currentLoopData = $agencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($agency->AgencyID); ?>"><?php echo e($agency->AgencyName); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>

                            <div class="w-full">
                                <label for="admin_comments" class="block text-sm font-medium text-gray-700 mb-2">
                                    <i class="fas fa-comment-alt mr-1"></i>Assignment Comments & Instructions
                                </label>
                                <textarea 
                                    name="admin_comments" 
                                    id="admin_comments" 
                                    ...
                                    placeholder="Add comments or instructions for the agency (optional)..."
                                    ></textarea>
                                <p class="text-sm text-gray-500 mt-1">
                                    <i class="fas fa-info-circle mr-1"></i>Optional: Add context, priority level, special requirements, or guidance for the assigned agency.
                                </p>
                            </div>
                            ...
                            <div class="flex gap-2">
                                ...
                                <button type="submit" class="assign-button flex-1" id="assignButton" disabled>
                ...
                <div class="filter-section">
                    <form method="GET" action="<?php echo e(route('admin.assign.inquiry')); ?>" class="filter-form">
                        ...
                        <select name="status">
                            ...
                            <option value="Verified as True" <?php echo e(request('status') == 'Verified as True' ? 'selected' : ''); ?>>Verified as True</option>
                            <option value="Identified as Fake" <?php echo e(request('status') == 'Identified as Fake' ? 'selected' : ''); ?>>Identified as Fake</option>
                            <option value="Rejected" <?php echo e(request('status') == 'Rejected' ? 'selected' : ''); ?>>Rejected</option>
                        </select>
                        <select name="agency">
                            <option value="">All Agencies</option>
                            <option value="unassigned" <?php echo e(request('agency') == 'unassigned' ? 'selected' : ''); ?>>Unassigned</option>
                            <?php $__currentLoopData = $agencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($agency->AgencyID); ?>" <?php echo e(request('agency') == $agency->AgencyID ? 'selected' : ''); ?>>
                                    <?php echo e($agency->AgencyName); ?>

                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <button type="submit">Filter</button>
                        <a href="<?php echo e(route('admin.assign.inquiry')); ?>" class="filter-form button clear-button"
                                ...
                                <?php $__currentLoopData = $inquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="checkbox-cell">
                                            <?php if(!$inquiry->AgencyID): ?>
                                                <input type="checkbox" name="inquiry_ids[]" value="<?php echo e($inquiry->InquiryID); ?>" 
                                        ...
                                        <td><?php echo e($inquiry->InquirySendDate ? $inquiry->InquirySendDate->format('Y-m-d H:i') : 'N/A'); ?></td>
                                        <td>
                                            <span class="status-badge status-<?php echo e(strtolower(str_replace(' ', '', $inquiry->InquiryStatus))); ?>">
                                                <?php echo e($inquiry->InquiryStatus); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <?php if($inquiry->agency): ?>
                                                <div class="flex items-center gap-2">
                                                    <div class="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center text-xs font-medium text-blue-800">
                                                        <?php echo e(substr($inquiry->agency->AgencyName, 0, 1)); ?>

                                                    </div>
                                                    <div>
                                                        <div class="font-medium text-sm"><?php echo e($inquiry->agency->AgencyName); ?></div>
                                                        <?php if($inquiry->assignment_date): ?>
                                                            <div class="text-xs text-gray-500">
                                                                Assigned <?php echo e($inquiry->assignment_date->format('M j, Y')); ?>
        ...
        <div id="viewPage" class="content-page">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($inquiries->where('InquiryStatus', 'Under Investigation')->count()); ?></div>
                                            ...
                                            <?php if($inquiry->agency): ?>
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <?php if($inquiry->assignment_date): ?>
                                                            <div class="text-xs text-gray-500">
                                                                Assigned <?php echo e($inquiry->assignment_date->format('g:i A')); ?>
        ...
        <div id="notesPage" class="content-page">
            ...
            <div class="card">
                ...
                <div class="assignment-section">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.assign.inquiries.with.notes')); ?>" class="assignment-form" id="notesAssignmentForm">
                        <?php echo csrf_field(); ?>
                        <div class="flex flex-col gap-4 w-full">
                            ...
                            <div class="flex gap-2">
                                ...
                                <input type="date" name="expected_completion" class="form-select" 
                                       min="<?php echo e(date('Y-m-d')); ?>" placeholder="Expected completion date">
                            </div>
                            ...
                            <?php if($inquiries->count() > 0): ?>
                                <?php $__currentLoopData = $inquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($inquiry->assignment_notes): ?>
                                                <div class="text-sm bg-yellow-50 p-2 rounded border-l-4 border-yellow-400">
                                                    <div class="font-medium text-yellow-800">Notes:</div>
                                                    <div class="text-yellow-700"><?php echo e(Str::limit($inquiry->assignment_notes, 100)); ?></div>
                                                    <?php if($inquiry->priority_level && $inquiry->priority_level !== 'normal'): ?>
                                                        <div class="mt-1">
                                                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium
                                                                <?php echo e($inquiry->priority_level === 'urgent' ? 'bg-red-100 text-red-800' : 'bg-orange-100 text-orange-800'); ?>">
                                                                <?php echo e(ucfirst($inquiry->priority_level)); ?> Priority
                                                            </span>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
...
<?php /**PATH C:\xampp\htdocs\SPM\MCMC_S02_Astrolabe\myApp\resources\views/Module3/Admin/assignInquiry.blade.php ENDPATH**/ ?>
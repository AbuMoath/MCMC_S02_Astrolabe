...
<body>
    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.reports.agency.dashboard')); ?>" class="sidebar-link active">
            ...
            <form id="reportFilters">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" name="start_date" class="form-control" value="<?php echo e(date('Y-m-d', strtotime('-3 months'))); ?>">
                    </div>
                    <div class="form-group">
                        <label class="form-label">End Date</label>
                        <input type="date" name="end_date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                    <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\mcmc\myApp\resources\views/Module4/admin/agency-performance-reports.blade.php ENDPATH**/ ?>
...
<body>
    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            <a href="<?php echo e(route('public.user.home')); ?>" class="sidebar-link active">
    ...
    <main class="main-content">
        ...
        <section class="hero-section">
            <div class="hero-content">
                ...
                <div class="hero-cta">
                    <a href="<?php echo e(route('profile.manage')); ?>" class="cta-button cta-primary">
                        <i class="fas fa-user-cog"></i>
                        Manage Profile
                    </a>
                    <a href="<?php echo e(route('submit.inquiry')); ?>" class="cta-button cta-secondary">
                        <i class="fas fa-edit"></i>
                        Submit Your Inquiry
                    </a>
                </div>
        ...
        <section class="quick-actions">
            <div class="actions-container">
                ...
                <div class="actions-grid">
                    <a href="<?php echo e(route('profile.manage')); ?>" class="action-card">
                    ...
                    <a href="<?php echo e(route('password.edit')); ?>" class="action-card">
                        <div class="action-icon">
...
<?php /**PATH C:\xampp\htdocs\mcmc\myApp\resources\views/shared publicUser page/publicUserHome.blade.php ENDPATH**/ ?>
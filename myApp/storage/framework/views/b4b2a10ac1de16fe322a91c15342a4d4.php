...
<body>
    ...
    <header class="top-bar">
        ...
        <div class="user-info-topbar">
            <div class="welcome">
                Welcome<br><?php echo e(DB::table('administrators')->first()->AdminName ?? 'Admin'); ?>
    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.notifications')); ?>" class="sidebar-link">
...
<?php /**PATH C:\xampp\htdocs\mcmc\myApp\resources\views/shared admin page/assignInquiry.blade.php ENDPATH**/ ?>
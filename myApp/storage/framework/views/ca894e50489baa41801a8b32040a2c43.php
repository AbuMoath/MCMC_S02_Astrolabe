        ...
        <div class="card">
            ...
            <?php if(session('success')): ?>
                <div class="alert alert-success">
                    <i class="fas fa-check-circle" style="margin-right: 0.5rem;"></i><?php echo e(session('success')); ?>

                </div> <?php endif; ?>

            <form method="POST"
                                action="<?php echo e(route('login')); ?>" novalidate>
                                <?php echo csrf_field(); ?>

                                <div class="input-group">
                                    <span class="input-icon <?php $__errorArgs = ['login'];
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <input type="text" id="login" name="login" value="<?php echo e(old('login')); ?>"
                                        required class="input-smooth <?php $__errorArgs = ['login'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="input-group">
                                    <span class="input-icon <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <input type="password" name="password" required
                                        class="input-smooth <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div style="margin-bottom:1rem;">
                                    <a href="<?php echo e(route('password.recovery')); ?>" class="forgot-link">
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        const clearForm = urlParams.get('clear') === '1' ||
                                                        ...
                                                        <?php if(session('login_successful')): ?> true <?php else: ?> false <?php endif; ?>;
...
<?php /**PATH C:\Users\khale\Desktop\MCMC_S02_Astrolabe\myApp\resources\views/home/loginPage.blade.php ENDPATH**/ ?>
        ...
        <div class="edit-container">
            <div class="edit-header">
                <div class="content">
                    ...
                    <span class="edit-subtitle"><?php echo e($agency->AgencyName ?? 'Agency'); ?></span>
                </div>
            </div>
            ...
            <div class="edit-content">
                ...
                <form method="POST" action="<?php echo e(route('admin.agency.update', $agency->AgencyID)); ?>">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>

                    <div class="form-group">
                        <label for="AgencyName"><i class="fas fa-building mr-2"></i>Agency Name</label>
                        <input type="text" name="AgencyName" id="AgencyName" value="<?php echo e($agency->AgencyName); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="AgencyUserName" id="AgencyUserName"
                            value="<?php echo e($agency->AgencyUserName); ?>" placeholder="Enter username" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="AgencyEmail" id="AgencyEmail" value="<?php echo e($agency->AgencyEmail); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="AgencyPhoneNum" id="AgencyPhoneNum"
                            value="<?php echo e($agency->AgencyPhoneNum); ?>" placeholder="Enter phone number (optional)">
...
<?php /**PATH C:\xampp\htdocs\mcmc\myApp\resources\views/Module1/admin/editAgencyPage.blade.php ENDPATH**/ ?>
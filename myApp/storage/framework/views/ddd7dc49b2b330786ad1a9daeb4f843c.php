...
<body>
    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.notifications')); ?>" class="sidebar-link active">
    ...
    <main class="main-content">
        <div class="content-card">
            ...
            <div class="nav-buttons">
                <?php if(!empty($notifications) && $notifications->count() > 0): ?>
                    <button onclick="markAllAsRead()" class="nav-btn btn-danger">
                        <i class="fas fa-check-double"></i>
                        Mark All as Read
                    </button>
                <?php endif; ?>
                <a href="<?php echo e(route('admin.home')); ?>" class="nav-btn">
            ...
            <?php else: ?>
                <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="notification-item <?php echo e(($notification->is_read ?? false) ? 'read' : 'unread'); ?>" id="notification-<?php echo e($notification->id); ?>">
                        ...
                        <div class="notification-meta">
                            <?php if(isset($notification->type) && $notification->type == 'agency_note'): ?>
                                
                                <span><strong>Inquiry:</strong> #<?php echo e($notification->inquiry_id); ?></span>
                                <span><strong>Agency:</strong> <?php echo e(($notification->inquiry && $notification->inquiry->agency ? $notification->inquiry->agency->AgencyName : 'System')); ?></span>
                                <span><strong>Time:</strong> <?php echo e(($notification->created_at ? $notification->created_at->format('M j, Y \a\t g:i A') : 'Unknown')); ?></span>
                                <span class="status-badge status-agency-note">Agency Note</span>
                            <?php else: ?>
                                
                                <span><strong>Inquiry:</strong> #<?php echo e($notification->inquiry_id ?? 'N/A'); ?></span>
                                <span><strong>Officer:</strong> <?php echo e(($notification->inquiry && $notification->inquiry->agency ? $notification->inquiry->agency->AgencyName : 'System') ?? 'System'); ?></span>
                                <span><strong>Time:</strong> <?php echo e(($notification->created_at ? $notification->created_at->format('M j, Y \a\t g:i A') : 'Unknown') ?? 'Unknown'); ?></span>
                                <?php if(isset($notification['status_update'])): ?>
                                    <span class="status-badge status-<?php echo e($notification['status_update']); ?>">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $notification['status_update']))); ?>
                        ...
                        <div class="notification-message">
                            ...
                            <?php if(!($notification->is_read ?? false)): ?>
                                <button onclick="markAsRead('<?php echo e($notification->id); ?>')" class="btn btn-success">
                                    <i class="fas fa-check"></i>
                                    Mark as Read
                                </button>
                            <?php endif; ?>
                            <?php if(isset($notification->inquiry_id)): ?>
                                <a href="<?php echo e(route('admin.inquiry.details', $notification->inquiry_id)); ?>" class="btn btn-primary">
...
<?php /**PATH C:\xampp\htdocs\SPM\MCMC_S02_Astrolabe\myApp\resources\views/Module4/admin/notification.blade.php ENDPATH**/ ?>
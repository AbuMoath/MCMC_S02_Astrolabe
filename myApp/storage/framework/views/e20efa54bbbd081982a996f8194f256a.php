...
<head>
    ...
    <title>Notifications - AuthenticityHub</title>
...
<body>
    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            <a href="<?php echo e(url()->previous() !== request()->url() && url()->previous() !== '' ? url()->previous() : route('home')); ?>" class="sidebar-link">
            ...
            <a href="<?php echo e(route('password.edit')); ?>" class="sidebar-link">
    ...
    <div class="main-content">        <div class="content-card">
            ...
            <div class="nav-buttons">
                <a href="<?php echo e(route('inquiries.index')); ?>" class="nav-btn">
                    <i class="fas fa-list"></i>
                    View Inquiry List
                </a>
                <a href="<?php echo e(route('submit.inquiry')); ?>" class="nav-btn">
            ...
            <?php if(isset($notifications) && $notifications->count() > 0): ?>
                <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="notification-item">
                        <?php if($notification['type'] == 'inquiry_update'): ?>
                            ...
                            <div class="notification-status">
                                Your inquiry "<?php echo e($notification['inquiry']->InquiryTitle ?? 'Unknown Inquiry'); ?>" status:
                                <span class="status-badge 
                                    <?php if($notification['inquiry']->InquiryStatus == 'Pending'): ?> status-pending
                                    <?php elseif($notification['inquiry']->InquiryStatus == 'Under Investigation'): ?> status-investigation
                                    <?php elseif($notification['inquiry']->InquiryStatus == 'Verified as True'): ?> status-verified
                                    <?php elseif($notification['inquiry']->InquiryStatus == 'Verified as False'): ?> status-false
                                    <?php endif; ?>">
                                    <?php echo e($notification['inquiry']->InquiryStatus ?? 'Unknown Status'); ?>

                                </span>
                            </div>
                            <?php if($notification['inquiry']->VerificationDescription): ?>
                                <div style="color: #4b5563; margin-top: 0.5rem;">
                                    <strong>Details:</strong> <?php echo e($notification['inquiry']->VerificationDescription); ?>

                                </div>
                            <?php endif; ?>
                            <div class="notification-date">
                                Updated: <?php echo e($notification['date']->format('M j, Y \a\t g:i A')); ?>

                            </div>

                        <?php elseif($notification['type'] == 'agency_note'): ?>
                            ...
                            <div style="color: #4b5563; margin-top: 0.5rem;">
                                <strong>Regarding:</strong> <?php echo e($notification['inquiry']->InquiryTitle ?? 'Inquiry #' . $notification['inquiry_id']); ?>
                            ...
                            <?php if($notification['supporting_document']): ?>
                                <div style="margin-top: 0.75rem;">
                                    <a href="<?php echo e(asset('storage/' . $notification['supporting_document'])); ?>" 
                                       target="_blank" 
                            ...
                            <?php endif; ?>
                            <div class="notification-date">
                                Sent: <?php echo e($notification['date']->format('M j, Y \a\t g:i A')); ?>
...
<?php /**PATH C:\xampp\htdocs\mcmc\myApp\resources\views/Module4/publicUser/notification.blade.php ENDPATH**/ ?>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.agency.register')); ?>" class="sidebar-link active">
    ...
    <div class="main-content page-transition">
        <div class="card">
            ...
            <form action="<?php echo e(route('admin.agency.store')); ?>" method="POST" id="agencyForm">
                <?php echo csrf_field(); ?>

                <div class="form-group">
                    <label for="AgencyName">Agency Name</label>
                    <input type="text" id="AgencyName" name="AgencyName" placeholder="Enter agency name" required
                        value="<?php echo e(old('AgencyName')); ?>" class="<?php echo e($errors->has('AgencyName') ? 'error' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="AgencyEmail" name="AgencyEmail" placeholder="Enter agency email address"
                        required value="<?php echo e(old('AgencyEmail')); ?>"
                        class="<?php echo e($errors->has('AgencyEmail') ? 'error' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="AgencyUserName" name="AgencyUserName" placeholder="Enter unique username"
                        required value="<?php echo e(old('AgencyUserName')); ?>"
                        class="<?php echo e($errors->has('AgencyUserName') ? 'error' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="AgencyPassword" name="AgencyPassword"
                        ...
                        class="<?php echo e($errors->has('AgencyPassword') ? 'error' : ''); ?>">
                    <?php $__errorArgs = ['AgencyPassword'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\xampp\htdocs\mcmc\myApp\resources\views/Module1/admin/registerNewAgencyPage.blade.php ENDPATH**/ ?>
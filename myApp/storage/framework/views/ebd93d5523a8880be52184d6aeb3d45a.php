        ...
        <div class="content-card">
            ...
            <?php else: ?>
                <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="notification-item <?php echo e(($notification['read'] ?? false) ? 'read' : 'unread'); ?>" id="notification-<?php echo e($notification['id']); ?>">
                        ...
                        <div class="notification-meta">
                            <?php if(isset($notification['type']) && $notification['type'] == 'agency_note'): ?>
                                ...
                                <span><strong>Agency:</strong> <?php echo e($notification['officer_name']); ?></span>
                                <span><strong>Time:</strong> <?php echo e($notification['timestamp']); ?></span>
                            ...
                            <?php else: ?>
                                ...
                                <span><strong>Officer:</strong> <?php echo e($notification['officer_name'] ?? 'System'); ?></span>
                                <span><strong>Time:</strong> <?php echo e($notification['timestamp'] ?? 'Unknown'); ?></span>
...
<?php /**PATH C:\xampp\htdocs\mcmc\myApp\resources\views/Module4/admin/notification.blade.php ENDPATH**/ ?>
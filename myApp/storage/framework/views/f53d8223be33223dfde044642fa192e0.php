...
<div class="notification-container" style="position: relative; margin-right: 1.5rem; display: flex; align-items: center;">
    ...
    <button type="button" class="notification-bell" onclick="toggleNotifications(event)" style="background: none; border: none; cursor: pointer; color: inherit; font-size: 1.25rem; display: flex; align-items: center; position: relative; padding: 0;">
        ...
        <?php if($unreadCount > 0): ?>
            <span id="notif-badge" class="badge" style="position: absolute; top: -5px; right: -8px; background: #e74c3c; color: white; border-radius: 50%; font-size: 0.65rem; padding: 2px 5px; font-weight: bold; min-width: 15px; text-align: center;"><?php echo e($unreadCount); ?></span>
        <?php endif; ?>
    </button>
        ...
        <div class="dropdown-body" style="max-height: 300px; overflow-y: auto; background: #ffffff;">
            <?php if($notifications->count() > 0): ?>
                <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="notification-item <?php echo e($notif->is_read ? 'read' : 'unread'); ?>" style="padding: 16px; border-bottom: 1px solid #f0f0f0; transition: background 0.2s ease; <?php echo e(!$notif->is_read ? 'background: #f8fbff;' : ''); ?>">
                        <p style="margin: 0 0 4px 0; font-size: 0.9rem; color: #333; line-height: 1.4;"><?php echo e($notif->message ?? $notif->title); ?></p>
                        <span style="font-size: 0.75rem; color: #888;"><?php echo e($notif->created_at->diffForHumans()); ?></span>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\SPM\MCMC_S02_Astrolabe\myApp\resources\views/partials/notifications.blade.php ENDPATH**/ ?>
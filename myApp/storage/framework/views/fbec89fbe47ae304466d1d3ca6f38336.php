    ...
    <header class="top-bar">
        ...
        <div class="user-area">
            ...
            <div class="profile-pic-container">
                ...
                <?php else: ?>
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($agency->AgencyName)); ?>&background=eeeeee&color=666666"
                        alt="Profile Picture">
                <?php endif; ?>
            </div>
        </div>
    ...
    <aside class="sidebar">
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('agency.profile')); ?>" class="sidebar-link"><i class="fas fa-cog"></i>
                <span>Profile</span></a>
            <a href="<?php echo e(route('agency.security')); ?>" class="sidebar-link active"><i class="fas fa-shield-alt"></i>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                            ...
                            <a href="<?php echo e(route('agency.password.edit.reset')); ?>" class="btn-secondary">
...
<?php /**PATH C:\xampp\htdocs\mcmc\myApp\resources\views/Module1/agency/editPasswordPage.blade.php ENDPATH**/ ?>